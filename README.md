...
2. Unzip the mask_files.zip file from imd_dashboard/data and use these as we have ordered them according to district FID numbers
3. Download files in src and run the index.py file after doing the following:
